  ...
  return (
    <>
      <div className={"flex gap-1 p-4 border-2"}>
        <img
          className="w-2/12 md:rounded-none rounded-full"
        ...
        <div className={"w-5/12 flex flex-col justify-center p-4"}>
          <h1
            data-testid={`administration-movie-title`}
        ...
        <div className={"w-3/12 flex flex-col justify-center p-4"}>
          <Link
            data-testid={`administration-edit-movie-button`}
            className={
              "block bg-gray-900 text-white rounded-md w-full mt-2 mb-1 px-3 py-2 text-sm font-medium text-center"
            }
            to={`${movie.id}/edit`}
          >
            Edytuj
          ...
          <button
            data-testid={`administration-archive-movie-button`}
            className={
              "block bg-gray-900 text-white rounded-md w-full mt-1 mb-1 px-3 py-2 text-sm font-medium text-center"
            }
          ...
          <button
            data-testid={`administration-delete-movie-button`}
            className={
              "block bg-gray-900 text-white rounded-md w-full mt-1 mb-2 px-3 py-2 text-sm font-medium text-center"
            }
